  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(children: <Widget>[
        Container(decoration: BoxDecoration(color: Color(0xff102733))),
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return DateTitle(
                                ...
                                isSelected: todaysDateIs == dates[index].date,
                              );
                            })),
                    SizedBox(
                      height: 16,
...
class DateTitle extends StatelessWidget {
  ...
  String date;
  bool isSelected;
  DateTitle({this.weekDay, this.date, this.isSelected});
...
class EventTitle extends StatelessWidget {
  ...
  String eventType;
  EventTitle({this.imageAssetPath, this.eventType});
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            Image.asset(imageAssetPath, height: 27),
            SizedBox(
              height: 12,
            ),
            Text(
...
class PopularEventTitle extends StatelessWidget {
  String desc;
  String date;
  String address;
  String imageAssetPath;
  PopularEventTitle({this.desc, this.date, this.address, this.imageAssetPath});
  @override
  Widget build(BuildContext context) {
    return Container(
      height: 100,
